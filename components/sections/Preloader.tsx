    ...
    <AnimatePresence>
      {loading && (
        <motion.div
          ...
          className="fixed inset-0 z-[9999] bg-background text-foreground flex flex-col items-center justify-center"
        >
          {/* Background effects */}
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute top-[10%] left-[15%] w-[300px] h-[300px] rounded-full bg-maroon/10 dark:bg-maroon/5 animate-pulse-glow" />
            <div className="absolute top-[60%] right-[10%] w-[200px] h-[200px] rounded-full bg-maroon-light/10 dark:bg-maroon-light/5 animate-pulse-glow animation-delay-1000" />
            <div className="absolute bottom-[20%] left-[40%] w-[150px] h-[150px] rounded-full bg-maroon/10 dark:bg-maroon/5 animate-pulse-glow animation-delay-2000" />
          </div>
          ...
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_50%,rgba(0,0,0,0.06)_100%)] dark:bg-[radial-gradient(ellipse_at_center,transparent_50%,rgba(0,0,0,0.5)_100%)]" />
          ...
          <div className="relative z-10 text-center">
            ...
            >
              <Logo size="lg" linked={false} className="dark:brightness-0 dark:invert" />
            </motion.div>
            ...
            <motion.h1
              ...
              className="font-sora font-extrabold text-2xl sm:text-3xl text-foreground mb-3"
            >
              {message.title}
            </motion.h1>
            ...
            <motion.p
              ...
              className="font-sora text-sm sm:text-base text-muted-foreground max-w-sm mx-auto leading-relaxed mb-8"
            >
              {message.subtitle}
            </motion.p>
            ...
            <motion.div
              ...
              className="font-sora font-medium text-xs text-muted-foreground uppercase tracking-[0.4em] mb-8"
            >
              {message.status}
            </motion.div>
            ...
            <motion.div
              ...
              className="w-[180px] h-[1.5px] bg-border rounded-sm mx-auto relative overflow-hidden"
            >
              <motion.div
            ...
            <motion.div
              ...
              className="mt-6 font-sora font-semibold text-[0.7rem] text-muted-foreground tracking-[0.15em] tabular-nums"
            >
          ...
          <motion.div
            ...
            animate={{ opacity: 0.2 }}
            transition={{ delay: 1.4 }}
            className="absolute bottom-10 left-1/2 -translate-x-1/2 text-[0.7rem] text-muted-foreground/70 tracking-[0.1em]"
          >
